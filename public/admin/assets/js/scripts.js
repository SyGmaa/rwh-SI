...
$(function () {
  ...
  $("[data-toggle='sidebar']").click(function () {
    ...
    if (w.outerWidth() <= 1024) {
      ...
      // Save the mini sidebar setting to localStorage
      $("#mini_sidebar_setting").prop("checked", body.hasClass("sidebar-mini"));
      saveSettings();
    }
  ...
  function saveSettings() {
    var settings = {
      layout: $(".select-layout:checked").val() == "1" ? "light" : "dark",
      sidebar: $(".select-sidebar:checked").val() == "1" ? "light" : "dark",
      theme: $(".choose-theme li.active").attr("title"),
      miniSidebar: $("#mini_sidebar_setting").is(":checked"),
      stickyHeader: $("#sticky_header_setting").is(":checked")
    };
  ...
  function loadSettings() {
    ...
    if (settings) {
      ...
      // Apply layout
      if (settings.layout === "dark") {
        $(".select-layout[value='2']").prop("checked", true);
        $(".select-layout[value='1']").prop("checked", false);
        $(".layout-color input:radio[value='2']").prop("checked", true);
        $(".layout-color input:radio[value='1']").prop("checked", false);
        ...
        $(".select-layout[value='1']").prop("checked", true);
        $(".select-layout[value='2']").prop("checked", false);
        $(".layout-color input:radio[value='1']").prop("checked", true);
        $(".layout-color input:radio[value='2']").prop("checked", false);
      ...
      if (settings.sidebar === "dark") {
        $(".select-sidebar[value='2']").prop("checked", true);
        $(".select-sidebar[value='1']").prop("checked", false);
        $(".sidebar-color input:radio[value='2']").prop("checked", true);
        $(".sidebar-color input:radio[value='1']").prop("checked", false);
        $("body").removeClass("light-sidebar").addClass("dark-sidebar");
      } else {
        $(".select-sidebar[value='1']").prop("checked", true);
        $(".select-sidebar[value='2']").prop("checked", false);
        $(".sidebar-color input:radio[value='1']").prop("checked", true);
        $(".sidebar-color input:radio[value='2']").prop("checked", false);
        $("body").removeClass("dark-sidebar").addClass("light-sidebar");
      }
      ...
      if (settings.theme) {
        $(".choose-theme li").removeClass("active");
        $(".choose-theme li[title='" + settings.theme + "']").addClass("active");
  ...
  // Hook saveSettings to change events
