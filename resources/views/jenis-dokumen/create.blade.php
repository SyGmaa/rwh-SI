                  ...
                  <div class="card-body">
                    ...
                    <form action="{{ route('jenis-dokumen.store') }}" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="custom-switches-stacked mt-2">
                          <label class="custom-switch">
                            <input type="radio" name="wajib_upload" value="1" class="custom-switch-input" {{ old('wajib_upload', 0) == 1 ? 'checked' : '' }} checked>
                            <span class="custom-switch-indicator"></span>
                            <span class="custom-switch-description">Ya</span>
                          </label>
                          <label class="custom-switch">
                            <input type="radio" name="wajib_upload" value="0" class="custom-switch-input">
                            <span class="custom-switch-indicator"></span>
                      ...
                      <div class="form-group">
                        ...
                        <div class="custom-switches-stacked mt-2">
                          <label class="custom-switch">
                            <input type="radio" name="is_active" value="1" class="custom-switch-input" {{ old('is_active', 1) == 1 ? 'checked' : '' }} checked>
                            <span class="custom-switch-indicator"></span>
