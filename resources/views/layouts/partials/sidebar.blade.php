  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="{{ request()->routeIs('log-activity.index') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('log-activity.index') }}"><i data-feather="sliders"></i><span>Log
            Activity</span></a>
      </li>
      <li class="{{ request()->routeIs('user-management.index') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('user-management.index') }}"><i data-feather="users"></i><span>Manajemen
            Pengguna</span></a>
      </li>
      <li class="{{ request()->routeIs('calendar.index') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('calendar.index') }}"><i
      ...
      <li class="dropdown {{ request()->routeIs('jadwal-keberangkatan.*') ? 'active' : '' }}">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="calendar"></i><span>Jadwal
            Keberangkatan</span></a>
        <ul class="dropdown-menu">
          @foreach($jenisPakets as $jenis)
          <li
            class="{{ request()->routeIs('jadwal-keberangkatan.index') && request('jenis_id') == $jenis->id ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('jadwal-keberangkatan.index', ['jenis_id' => $jenis->id]) }}">{{
              $jenis->nama_jenis }}</a>
          </li>
          @endforeach
        </ul>
      ...
      <li class="dropdown {{ request()->routeIs('pendaftaran.*') ? 'active' : '' }}">
        ...
        <ul class="dropdown-menu">
          @foreach($jenisPakets as $jenis)
          <li
            class="{{ request()->routeIs('pendaftaran.index') && request('jenis_id') == $jenis->id ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('pendaftaran.index', ['jenis_id' => $jenis->id]) }}">{{
              $jenis->nama_jenis }}</a>
          </li>
          @endforeach
      ...
      <li class="dropdown {{ request()->routeIs('jemaah.*') ? 'active' : '' }}">
        ...
        <ul class="dropdown-menu">
          @foreach($jenisPakets as $jenis)
          <li class="{{ request()->routeIs('jemaah.index') && request('jenis_id') == $jenis->id ? 'active' : '' }}"><a
              class="nav-link" href="{{ route('jemaah.index', ['jenis_id' => $jenis->id]) }}">{{ $jenis->nama_jenis
              }}</a></li>
          @endforeach
        </ul>
      </li>
      <li class="dropdown {{ request()->routeIs('dokumen-jemaah.*') ? 'active' : '' }}">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="file-text"></i><span>Dokumen
            Jemaah</span></a>
        <ul class="dropdown-menu">
          @foreach($jenisPakets as $jenis)
          <li
            class="{{ request()->routeIs('dokumen-jemaah.index') && request('jenis_id') == $jenis->id ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('dokumen-jemaah.index', ['jenis_id' => $jenis->id]) }}">{{
              $jenis->nama_jenis }}</a>
          </li>
          @endforeach
      ...
      <li class="dropdown {{ request()->routeIs('cicilan-jemaah.*') ? 'active' : '' }}">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="dollar-sign"></i><span>Cicilan
            Jemaah</span></a>
        <ul class="dropdown-menu">
          @foreach($jenisPakets as $jenis)
          <li
            class="{{ request()->routeIs('cicilan-jemaah.index') && request('jenis_id') == $jenis->id ? 'active' : '' }}">
            <a class="nav-link" href="{{ route('cicilan-jemaah.index', ['jenis_id' => $jenis->id]) }}">{{
              $jenis->nama_jenis }}</a>
          </li>
          @endforeach
        </ul>
      </li>
      <li class="dropdown {{ request()->routeIs('laporan-keuangan.index') ? 'active' : '' }}">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="bar-chart-2"></i><span>Laporan
            Keuangan</span></a>
        <ul class="dropdown-menu">
          <li class="{{ request()->routeIs('laporan-keuangan.index') ? 'active' : '' }}"><a class="nav-link"
              href="{{ route('laporan-keuangan.index') }}">Ringkasan</a></li>
        </ul>
      </li>

      <li class="menu-header">Pengaturan</li>
      <li class="{{ request()->routeIs('settings.index') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('settings.index') }}"><i data-feather="settings"></i><span>Pengaturan
            Aplikasi</span></a>
      </li>
      ...
      <li class="dropdown {{ request()->routeIs('paket.*') || request()->routeIs('jenis-paket.*') ? 'active' : '' }}">
        ...
        <ul class="dropdown-menu">
          <li class="{{ request()->routeIs('jenis-paket.index') ? 'active' : '' }}"><a class="nav-link"
              href="{{ route('jenis-paket.index') }}">Jenis Paket</a></li>
          @foreach($jenisPakets as $jenis)
          <li class="{{ request()->routeIs('paket.index') && request('jenis_id') == $jenis->id ? 'active' : '' }}"><a
              class="nav-link" href="{{ route('paket.index', ['jenis_id' => $jenis->id]) }}">{{ $jenis->nama_jenis
              }}</a></li>
          @endforeach
        </ul>
      </li>
      <li class="dropdown {{ request()->routeIs('jenis-dokumen.*') ? 'active' : '' }}">
        <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="pie-chart"></i><span>Dokumen</span></a>
        <ul class="dropdown-menu">
          <li class="{{ request()->routeIs('jenis-dokumen.index') ? 'active' : '' }}"><a class="nav-link"
              href="{{ route('jenis-dokumen.index') }}">Jenis Dokumen</a></li>
          {{-- <li><a class="nav-link" href="chart-apexchart.html">apexchart</a></li>
          <li><a class="nav-link" href="chart-echart.html">eChart</a></li>
          <li><a class="nav-link" href="chart-chartjs.html">Chartjs</a></li>
          <li><a class="nav-link" href="chart-sparkline.html">Sparkline</a></li>
